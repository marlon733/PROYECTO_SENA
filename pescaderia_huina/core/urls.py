...
urlpatterns = [
    ...
    path('panel_de_control/', views.dashboard_view, name='dashboard'),
    ...
    path('inventario/', views.pagina_inventario, name='inventario'),
    path('descargar-manual/', views.descargar_manual_usuario, name='descargar_manual'),
    ]